          ...
          <div class="row">
            <div class="col-md-12">
              ...
              @if(Auth::check() and \App\Reviews::checkUserReview(Auth::id(),$listing->id)=='' and Auth::id()!=$listing->user_id)
                 <div class="review"> <a class="contact-inst-btn pull-right" role="button" data-toggle="collapse" href="#review" aria-expanded="false" aria-controls="review"> Write A Review </a> </div>
             
              @elseif(\App\Reviews::checkUserReview(Auth::id(),$listing->id)!='')

              <div class="review"><a href="#0" class="contact-inst-btn pull-right"">
            Already reviewed</a></div>
               
              @elseif(Auth::id()!=$listing->user_id)
                 <div class="review"> <a class="contact-inst-btn pull-right"" role="button" href="{{ URL::to('login') }}"> Write A Review </a> </div>
              @endif
