		...
		<div class="collapse navbar-collapse" id="myNavbar">
				  ...
				  <ul class="nav navbar-nav navi-left-padding">
					<li><a href="{{ URL::to('/') }}">{{trans('messages.home')}}</a></li>
                      ...
                      <li class="dropdown drop-down" ><a class="dropdown-toggle" data-toggle="dropdown" href="#">{{trans('messages.find_cources')}}</a>
                                         <ul class="dropdown-menu">
                                           <li><a href="{{ URL::to('services') }}">{{trans('messages.services')}}</a></li>
					<li class="dropdown drop-down drob-sub" ><a class="dropdown-toggle" data-toggle="dropdown" href="#">{{trans('messages.features')}}</a>
                                         <ul class="dropdown-menu featyres-ui">
                                            <li><a href="{{ URL::to('feature_universities') }}">{{trans('messages.features_universities')}}</a></li>
                                            <li><a href="{{ URL::to('feature_courses') }}">{{trans('messages.features_courses')}}</a></li>
                                          </ul>
                                        </li>
					<li><a href="{{ URL::to('universities') }}">{{trans('messages.universities')}}</a></li>
					<li><a href="#">{{trans('messages.promotions')}}</a></li>
					<li><a href="{{ URL::to('downloads') }}">{{trans('messages.download')}}</a></li>
                                          </ul>
                                        </li>
                      <li class="dropdown drop-down" ><a class="dropdown-toggle" data-toggle="dropdown" href="#">{{trans('messages.about_us')}}</a>
                                         <ul class="dropdown-menu">
                                           <li><a href="{{ URL::to('services') }}">{{trans('messages.contact_us')}}</a></li>
                                          </ul>
                                        </li>
