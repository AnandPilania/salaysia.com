...
@section('head_title', 'My Universities | '.getcong('site_name') )
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">My Universities</li>
        </ol>
      </div>
    </div>
  </div>
     ...
     <div class="col-md-9 col-sm-9 content-right bg-gry">
        ...
        <div class="well-box">
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('submit_front_university/'.$listing->id)}}" class="btn btn-info">Edit</a> 
              <a href="{{URL::to('delete_listing/'.$listing->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to commit delete and go back?')">Delete</a>
              </td>
          </tr>
          @endforeach
