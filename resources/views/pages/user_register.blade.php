...
<li class="active">{{ isset($user->id) ? 'Edit User' : 'Add User' }}</li>
        </ol>
      </div>
    </div>
  </div>
     ...
     <div class="col-md-9 col-sm-9 content-right bg-gry">
        <div class="row">
            <div class="bg-whit clearfix">
                <div class="col-md-12" id="aboutus">
                  <h1>{{ isset($user->id) ? 'Edit User' : 'Add User' }}</h1>                          
                  <div class="user-form">
                    <div class="block-content block-content-narrow"> 
                    {!! Form::open(array('url' => 'myuser_register','class'=>'','id'=>'register','role'=>'form')) !!} 
        ...
        @endif
            ...
            <div class="form-group">
              ...
              <input id="first_name" name="first_name" type="text" value="{{ isset($user->first_name) ? $user->first_name : null }}"  class="form-control input-md">
<input type="hidden" name="id" value="{{ isset($user->id) ? $user->id : null }}">
            ...
            <div class="form-group">
              ...
              <input id="last_name" name="last_name" type="text" value="{{ isset($user->last_name) ? $user->last_name : null }}" class="form-control input-md">
            </div>
            <div class="form-group">
              <label class="control-label" for="email">Email<span class="required">*</span></label>
              <input id="email" name="email" type="email" value="{{ isset($user->email) ? $user->email : null }}" class="form-control input-md">
            </div>
              <div class="form-group">
              <label class="control-label" for="email">Mobile</label>
              <input id="mobile" name="mobile" type="tel" value="{{ isset($user->mobile) ? $user->mobile : null }}" class="form-control input-md">
            </div>
<!--  <div class="form-group">
...
<div class="form-group">
<label class="control-label" for="email">Where Do You Want To Study?</label>
...
<option  <?php if(isset($user)){ if($user->country=='Zimbabwe'){ echo 'selected'; } } ?>  value="Zimbabwe">Zimbabwe</option>
                    ...
                    <div class="form-group">
			 <label class="control-label" for="email">When do you plan to study?</label>
			 
			 <select class="inputes-model1 form-control" name="study_plan">
				<option value="">When do you plan to study? *</option>
<optgroup label="2016">
<option <?php if(isset($user)){ if($user->study_plan=='July - Oct 2016'){ echo 'selected="selected"'; } } ?>value="July - Oct 2016">July - Oct</option>	
<option <?php if(isset($user)){ if($user->study_plan=='Nov - Dec 2016'){ echo 'selected="selected"'; } } ?>value="Nov - Dec 2016">Nov - Dec</option>	
</optgroup>
<optgroup label="2017">
<option <?php if(isset($user)){ if($user->study_plan=='Jan - March 2017'){ echo 'selected="selected"'; } } ?>value="Jan - March 2017">Jan - March</option>	
<option <?php if(isset($user)){ if($user->study_plan=='April - June 2017'){ echo 'selected="selected"'; } } ?>value="April - June 2017">April - June</option>	
<option <?php if(isset($user)){ if($user->study_plan=='July - Oct 2017'){ echo 'selected="selected"'; } } ?>value="July - Oct 2017">July - Oct</option>	
<option <?php if(isset($user)){ if($user->study_plan=='Nov - Dec 2017'){ echo 'selected="selected"'; } } ?>value="Nov - Dec 2017">Nov - Dec</option>	
</optgroup>
<optgroup label="2018">
<option <?php if(isset($user)){ if($user->study_plan=='Jan - March 2018'){ echo 'selected="selected"'; } } ?>value="Jan - March 2018">Jan - March</option>	
<option <?php if(isset($user)){ if($user->study_plan=='April - June 2018'){ echo 'selected="selected"'; } } ?>value="April - June 2018">April - June</option>	
<option <?php if(isset($user)){ if($user->study_plan=='July - Oct 2018'){ echo 'selected="selected"'; } } ?>value="July - Oct 2018">July - Oct</option>	
<option <?php if(isset($user)){ if($user->study_plan=='Nov - Dec 2018'){ echo 'selected="selected"'; } } ?>value="Nov - Dec 2018">Nov - Dec</option>	
</optgroup>
<optgroup label="2019">
<option <?php if(isset($user)){ if($user->study_plan=='Jan - March 2019'){ echo 'selected="selected"'; } } ?>value="Jan - March 2019">Jan - March</option>	
<option <?php if(isset($user)){ if($user->study_plan=='April - June 2019'){ echo 'selected="selected"'; } } ?> value="April - June 2019">April - June</option>	
</optgroup>	
                        </select>
			 </div>
            <div class="form-group">
