...
<section class="country-section">
	<div class="container">
		<h2>Study in the {{$listing->title}}</h2>
		<p>Study in {{$listing->title}}, the land of opportunities. Choose from some of the world’s top-ranking universities and earn a degree that is recognised all around the world.</p>
	</div>
</section>
...
<section class="management-uni">
	<div class="container">
		<div class="col-sm-9 ">
		<div class="country-tabss">			
		<img src="{{ URL::asset('upload/listings/'.$listing->featured_image.'-s.jpg') }}" class="img-responsive"/>
				
			<?php echo html_entity_decode($listing->description); ?>	
		</div>
		</div>
