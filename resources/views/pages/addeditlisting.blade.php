                ...
                <div class="row">
                    <div class="col-md-12" id="aboutus">
                        ...
                        <div class="well-box">
                            ...
                            <div class="form-group col-md-12">
                                <label for="first" class="control-label">Keywords:-</label>
                                <input type="text" class="form-control input-md" placeholder="Keywords like as dress,beautiful, .etc" name="keyword" id="keyword" value="{{ isset($listing->keyword) ? $listing->keyword : null }}" required>
                            </div>
