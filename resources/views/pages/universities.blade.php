@extends('app')
@section('head_title', 'Universities'.' | '.getcong('site_name') )     
@section('content')
...
<script type="text/javascript">
    $(document).ready(function(e) {
        $("#country").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "{{ URL::to('ajax_universities') }}/"+cat,
      ...
      $("#myInput").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "{{ URL::to('ajax_sortuniversities') }}/"+cat,
                success: function(result){
...
<section class="contact-form-section clearfix">
	<div class="container">
			...
			<h2 class="text-red">{{trans('home.tiuni')}}</h2>
...
<select id="myInput">
 <option value="all">{{trans('home.sorted_by')}}</option>
  ...
  <option value="Popularty">{{trans('home.popularty')}}</option>
