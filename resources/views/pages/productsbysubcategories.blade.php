    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>{{$sub_cat->sub_category_name}} Products</h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          ...
          <li class="active">{{$sub_cat->sub_category_name}} Products</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class=" text-center ">  
	<div class="col-sm-3">
		<div class="categories text-green">
			<p class="text-white bg-green heading"><a href="#" data-toggle="collapse" data-target="#colps1">ABOUT {{$sub_cat->sub_category_name}} <span class="downwrds"><img src="{{ URL::asset('site_assets/images/arrow-down.png') }}"/></span></a></p>
			<ul >
			
				<div id="colps1" class="collapse text-decor">
				<div class="sub text-black text-left">
				<p>{{$sub_cat->sub_category_name}} is</p>
...
<div class="col-sm-9 text-left"> 
   ...
   <div class="col-sm-11 nopadding">
		<h3>Best offers, deals and coupns from {{$sub_cat->sub_category_name}}</h3>
   </div>
   </div>
    @if ( !$listings ->count() )
