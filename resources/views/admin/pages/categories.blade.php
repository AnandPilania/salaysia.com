                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                ...
                                <li><a class="link-effect" href="">Course Categories</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">                            
                            <a class="pull-right btn btn-primary push-5-r push-10" href="{{URL::to('admin/categories/addcategory')}}"><i class="fa fa-plus"></i> Add Course Category</a>
                        </div>
...
<td>
                           ...
                           <img src="{{ URL::asset('upload/listings/'.$category->featured_image.'-s.jpg') }}" width="80" alt="featured">
                                    @endif
</td>
                                
<td class="font-w600">{{ $category->description }}</td>
