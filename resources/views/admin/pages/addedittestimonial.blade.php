    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                {{ isset($listing->id) ? 'Edit Testimonials ' : 'Add Testimonial' }}</h1>
            
        </div>
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="{{ URL::to('admin/dashboard') }}">Dashboard</a></li>
                 <li><a class="link-effect" href="{{ URL::to('admin/testimonials') }}">Testimonials</a></li>
                <li class="active">{{ isset($listing->id) ? 'Edit Testimonials ' : 'Add Testimonial' }}</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="block">
                    ...
                    {!! Form::open(array('url' => array('submit_testimonial'),'class'=>'','name'=>'listing_form','id'=>'listing_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12" id="aboutus">
                            ...
                            <div class="well-box">
                               ...
                               <div class="form-group col-md-12">
                                    <label for="first" class="control-label">Author Name :-</label>
                                    <input type="text" class="form-control input-md" placeholder="Author Name" name="author_name" id="title" value="{{ isset($listing->auther_name) ? $listing->auther_name : null }}" required>
                                </div>     
                            ...
                            <div class="well-box">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="first" class="control-label">Author Image :-</label>
