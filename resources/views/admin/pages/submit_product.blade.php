                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                ...
                                <li><a class="link-effect" href="">Products</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">                            
                            <a class="pull-right btn btn-primary push-5-r push-10" href="{{URL::to('submit_listing')}}" target="_blank"><i class="fa fa-plus"></i> Add Product</a>
