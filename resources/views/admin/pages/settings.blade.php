...
<!-- Page Header -->
  ...
  <div class="form-group">
                                            <label for="avatar" class="col-sm-3 control-label">Home Slide 4</label>
                                            <div class="col-sm-9">
                                                <div class="media">
                                                    <div class="media-left">
                                                        @if($settings->home_slide_image4)
                                                         
                                                            <img src="{{ URL::asset('upload/'.$settings->home_slide_image4) }}" alt="bg image" width="150">
                                                        @endif
                                                                                        
                                                    </div>
                                                    <div class="media-body media-middle">
                                                        <input type="file" name="home_slide_image4" class="filestyle">
                                                         <small class="text-muted bold">Size 1400x500px</small>
                                                    </div>
                                                </div>
                                            ...
                                            <label for="avatar" class="col-sm-3 control-label">Home Slide 5</label>
                                            <div class="col-sm-9">
                                                <div class="media">
                                                    <div class="media-left">
                                                        @if($settings->home_slide_image5)
                                                         
                                                            <img src="{{ URL::asset('upload/'.$settings->home_slide_image5) }}" alt="bg image" width="150">
                                                        @endif
                                                                                        
                                                    </div>
                                                    <div class="media-body media-middle">
                                                        <input type="file" name="home_slide_image5" class="filestyle">
                                                         <small class="text-muted bold">Size 1400x500px</small>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-8 tab-pane" id="services">

                                              
                                            {!! Form::open(array('url' => 'admin/servicesetting','class'=>'form-horizontal padding-15','name'=>'privacy_policy_form','id'=>'privacy_policy_form','role'=>'form')) !!}
                
                 
                                           <div class="form-group">
                                                <label for="" class="col-sm-3 control-label">Title</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="service_title" value="{{ $settings->service_title }}" class="form-control" value="">
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                                <label for="" class="col-sm-3 control-label">Services</label>
                                                <div class="col-sm-9">
                                                    <textarea type="text" name="service_description" class="js-summernote" rows="5">{{ $settings->service_description }}</textarea>
                                                </div>
