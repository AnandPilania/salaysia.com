                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                               {{ isset($cat->id) ? 'Edit Course Category ' : 'Add Course Category' }}
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li><a href="{{ URL::to('admin/categories') }}">Course Categories</a></li>
                                <li><a class="link-effect" href="">{{ isset($cat->id) ? 'Edit Course Category ' : 'Add Course Category' }}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                {!! Form::open(array('url' => array('admin/categories/addcategory'),'class'=>'form-horizontal padding-15','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Course Category Icon</label>
                                          <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Course Category Name</label>
                                          <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Course Category Slug</label>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Course Category Description</label>
                                            <div class="col-sm-9">
                                                <textarea type="text" name="description" class="form-control" rows="5" placeholder="A few words about Course Category">{{ isset($cat->description) ? $cat->description : null }}</textarea>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="" class="col-sm-3 control-label">The aim of the category</label>
                                            <div class="col-sm-9">
                                                <textarea type="text" name="aim_category" class="form-control" rows="5" placeholder="The aim of the category">{{ isset($cat->aim_category) ? $cat->aim_category : null }}</textarea>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Careers for the student graduate from this category</label>
                                            <div class="col-sm-9">
                                                <textarea type="text" name="careers_category" class="form-control" rows="5" placeholder="Careers for the student graduate from this category">{{ isset($cat->careers_category) ? $cat->careers_category : null }}</textarea>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Admission Requirements</label>
                                            <div class="col-sm-9">
                                                <textarea type="text" name="admission_category" class="form-control" rows="5" placeholder="Admission Requirements">{{ isset($cat->admission_category) ? $cat->admission_category : null }}</textarea>
                                            </div>
                                        </div>
										
  <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Course Category parent</label>
                                            <div class="col-sm-9">
                                              <select name="parent_id"> 
                                              <option value="">SelectParent</option>
                                              <?php if(isset($cat->id)){ ?>

                                               @foreach(\App\Categories::where('id','!=',$cat->id)->get() as $aes)
                                               <option value="{{$aes->id}}" <?php  if($cat->parent_id==$aes->id){ echo 'selected'; } ?> >{{$aes->category_name}}</option>
                                              @endforeach
                                              <?php }else{ ?>

                                              @foreach(\App\Categories::orderby('id')->get() as $aes)
                                              <option value="{{$aes->id}}">{{$aes->category_name}}</option>
                                              @endforeach
                                              <?php } ?>
...
<div class="col-md-6">
 ...
 @endif    
                                ...
                                <div class="col-md-3">
                                    ...
                                    <img src="{{ URL::asset('upload/listings/'.$cat->featured_image.'-s.jpg') }}" width="80" alt="featured">
                                    @endif
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-sm-9 ">
                                            <button type="submit" class="btn btn-primary">{{ isset($cat->id) ? 'Edit Course Category ' : 'Add Course Category' }}</button>
