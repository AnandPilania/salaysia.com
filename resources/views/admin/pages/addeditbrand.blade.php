    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                {{ isset($listing->id) ? 'Edit Brand ' : 'Add Brand' }}</h1>
            
        </div>
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="{{ URL::to('admin/dashboard') }}">Dashboard</a></li>
                 <li><a class="link-effect" href="{{ URL::to('admin/brands') }}">Brands</a></li>
                <li class="active">{{ isset($listing->id) ? 'Edit Brand ' : 'Add Brand' }}</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="block">
                    ...
                    {!! Form::open(array('url' => array('submit_brand'),'class'=>'','name'=>'listing_form','id'=>'listing_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12" id="aboutus">
                            ...
                            <div class="well-box">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="first" class="control-label">Services :-</label>
                                    <input type="text" class="form-control input-md" placeholder="Services" name="services" value="{{ isset($listing->services) ? $listing->services : null }}" >
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="first" class="control-label">Products :-</label>
                                    <input type="text" class="form-control input-md" placeholder="Products" name="products" value="{{ isset($listing->products) ? $listing->products : null }}" >
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="first" class="control-label">Team :-</label>
                                    <input type="text" class="form-control input-md" placeholder="team" name="team" value="{{ isset($listing->team) ? $listing->team : null }}">
                                </div>
                                <div class="form-group col-sm-12">
                                    <label for="first" class="control-label">Contact Us :-</label>
                                    <textarea rows="7" placeholder="Contact Us" name="contact_us" id="summernote" class="js-summernote form-control">{{ isset($listing->contact_us) ? $listing->contact_us : null }}</textarea>
                                </div>
