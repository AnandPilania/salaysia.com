                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                               ...
                               {{ isset($subcat->id) ? 'Edit Level' : 'Add Level' }}
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li><a href="{{ URL::to('admin/subcategories') }}">Level</a></li>
                                <li><a class="link-effect" href="">{{ isset($subcat->id) ? 'Edit Level ' : 'Add Level' }}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                {!! Form::open(array('url' => array('admin/subcategories/addsubcategory'),'class'=>'form-horizontal padding-15','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Level Name</label>
                                          <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Level Slug</label>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Level Description</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-sm-9 ">
                                            <button type="submit" class="btn btn-primary">{{ isset($subcat->id) ? 'Edit Level' : 'Add Level' }}</button>
