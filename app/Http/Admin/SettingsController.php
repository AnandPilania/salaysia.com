...
$home_slide_image4 = $request->file('home_slide_image4');
 if($home_slide_image4){
        	
        	 
            $tmpFilePath = 'upload/';			
			 
			$hardPath = 'home_slide_image4.png';
			
            $img = Image::make($home_slide_image4);

            $img->save($tmpFilePath.$hardPath); 
             
            $settings->home_slide_image4 = 'home_slide_image4.png';
            
             
        }
$home_slide_image5 = $request->file('home_slide_image5');
 if($home_slide_image5){
        	
        	 
            $tmpFilePath = 'upload/';			
			 
			$hardPath = 'home_slide_image5.png';
			
            $img = Image::make($home_slide_image5);

            $img->save($tmpFilePath.$hardPath); 
             
            $settings->home_slide_image5 = 'home_slide_image5.png';
    ...
    {  
		...
		$settings->service_title = $inputs['service_title']; 
		$settings->service_description = $inputs['service_description'];
